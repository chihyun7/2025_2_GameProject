...
public class CubeFactory : MonoBehaviour
{
    ...
    void AddMaterial()
    {
        ...
        ResourceType randomType = (Random.value > 0.5) ? ResourceType.Wood : ResourceType.Metal;
        ...
        Debug.Log($"{randomType} 원료 도착 , 큐 대 기 : {materialQueue.Count} 개 ");
    }
    ...
    void ProcessQueue()
    {
        ...
        if (resource.type == ResourceType.Wood)
        {
            ...
            Debug.Log($"나무창고입고 ! 창고  : {woodWarehouse.Count} 개 "); ;
        }
        else
        {
    ...
    void processRequests()
    {
        ...
        else
        {
            ...
            Debug.Log($"재고 부족 ! {needed} 개 더 필 요 (현 재  : {available}) 개");
        }
    }
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(10, 60, 250, 20), $"나무창고 스택 (Stack) : {woodWarehouse.Count}개 대기 ");
        GUI.Label(new Rect(10, 80, 250, 20), $"금속 스택 (Stack) : {metalWarehouse.Count}개 대기 ");
