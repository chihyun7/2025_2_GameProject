...
public class CityGenerator : MonoBehaviour
{
    ...
    {
        int floors = Random.Range(minBuildingHeight, minBuildingHeight);
        ...
        building.GetComponent<Renderer>().material.color = GetBuildlingColor(x, z);
;    }
    ...
    Color GetBuildlingColor(int x, int z)
    {
        ...
        { 
            return new Color(0.8f, 0.8f, 0.7f);
        }
        else
        {
